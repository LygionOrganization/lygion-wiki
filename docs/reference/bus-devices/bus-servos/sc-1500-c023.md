# SC-1500-C023 双轴 TTL 总线舵机

<a href="https://item.taobao.com/item.htm?id=984568824924&mi_id=0000ls26h7NYY2jUTbyrkd4Ux76oUsyKOW-wbFtGV93PCds&spm=a21xtw.29178619.0.0&xxc=shop&skuId=6111063527282" target="_blank">淘宝购买链接</a>

SC-1500-C023 是一款 15kg.cm 级双轴 TTL 串行总线舵机，规格书型号为 `SCS15-C023`。它采用塑胶壳、铁芯电机、铜齿轮和滚珠轴承，适合中等负载关节、双侧支撑连杆、移动机器人机构和教学平台。

![SC-1500-C023](assets/SC-1500-C023.webp){ .img-rounded width="420" }

<a class="md-button" href="assets/SC-1500-C023.step" target="_blank">下载 3D 模型</a>
...
- [舵机本体 STEP](assets/SC-1500-C023.step)
...
!!! warning "接线前核对实物线序"
    本型号使用 PH2.0-3P 接插件。请按规格书线序接入，不要与其它接口规格混插。
...
![SC-1500-C023 Motion Characteristics](assets/sc-1500-c023-motion-characteristics-en.png){ .img-rounded }

## 保护与可靠性

- 过载保护：负载大于堵转扭力的 80% 并持续 4s 后进入保护；重新发送位置指令可清除过载保护标志。
- 过压/欠压保护：大于 12.6V 或小于 9V 进入保护；电压恢复正常范围后自动解除。
- 过热保护：大于 70℃ 关闭扭矩输出。
- 最大位置更新率：1ms。
- 信号高电平：2~5V。
- 信号低电平：0~0.45V。
...
4. 双轴结构适合两侧支撑，安装时要保证支架同轴，避免额外侧向力。
